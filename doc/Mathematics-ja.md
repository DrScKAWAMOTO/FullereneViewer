...
　フラーレンの１２個の五員環のうち任意の２個を取り出し、距離を調べます。任意の異なる２個の五員環の距離とは、その２個の五員環を繋ぐリングからなるパスのうち、一番短いパスを構成するリングの数のことです。同じ五員環の距離は０とします。１２個の五員環の組み合わせは全部で１４４通りあるので、１４４個の距離が得られます。  
...
　例えばフラーレン C60 の場合は、 `12;0;60;60;0;12` です。例えばフラーレン C70 の場合は、 `12;0;50;40;40;2` です。
